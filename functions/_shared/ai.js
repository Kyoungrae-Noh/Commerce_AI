function buildJsonSchema(score) {
  ...
  "reasons": ["데이터 숫자를 근거로 긍정적 사실 3가지. 각각 한 문장."],
  "risks": ["데이터 숫자를 근거로 주의할 사실 2-3가지. 각각 한 문장."],
  "entryStrategy": "아래 '진입 전략 작성 규칙'을 따라 2-3문장으로 작성합니다.",
  "detectedCategory": "electronics | fashion | beauty | living | food | sports | kids | pet 중 하나"
}`
  }
  if (score >= 50) {
    return `{
...
8. '세트 구성', '인테리어 컨셉 포지셔닝' 같은 추상적 표현 대신 실제 행동을 구체적으로 쓰세요.
9. 현재 월(${new Date().getMonth() + 1}월)을 기준으로 계절성을 판단하세요. 계절과 명확히 관련된 상품만 계절성을 언급하세요. 강아지 간식, 생활 소모품, 보조배터리, 충전기, 케이블 등 계절과 무관한 상품은 계절성 언급을 절대 하지 마세요.

[계절성 판단 기준]
- 봄 시즌 준비(2~3월): 봄 의류/아웃도어 장비/가드닝 용품/봄 화장품/딸기
- 여름 시즌 준비(4~5월): 선풍기/손풍기/수영복/냉감 침구/자외선차단제/캠핑용품/수박/복숭아
- 가을 시즌 준비(7~8월): 가을 의류/트렌치코트/핫팩/가을 화장품/캠핑/등산용품
- 겨울 시즌 준비(9~11월): 극세사 이불/파자마/전기장판/방한용품/겨울 의류/보습 크림
- 연말/설 시즌 준비(11~12월): 선물세트/포장용품/명절 식품
- 봄/신학기 준비(1~2월): 학용품/책상/수납용품/새학기 의류

현재 월 기준으로 소싱 적기가 지난 계절 상품은 conclusion에 "현재는 소싱 적기가 아닙니다. 다음 시즌 준비는 [월]월부터 시작하세요."라고 명확히 경고하세요.

진입 전략 작성 규칙:
절대 금지 표현: '차별화', '마케팅 강화', '소비자 리뷰', '브랜드 인지도', '롱테일 키워드', '포지셔닝', '틈새 시장', '리뷰 축적', '시장 점유율', '빠른 진입', '쿠폰 지급', '할인 이벤트'
마케팅 전략 대신 소싱 관점에서 구체적으로 작성하세요.

[경쟁강도 점수 기준]
- 80 이상: 광범위 키워드로 직접 진입은 불리합니다. 더 구체적인 키워드 예시 2개를 제시하세요.
- 50~79: 상위 노출 경쟁이 가능한 수준입니다. 가격대나 특정 속성을 활용한 구체적 판매 전략을 제시하세요.
- 50 미만: 경쟁이 적어 선점 기회입니다. 초기에 어떤 방식으로 진입하면 유리한지 구체적으로 제시하세요.
...
- living: 세트 구성, 용도별 상품명으로 등록하는 전략을 반영하세요.
...
- 트렌드 점수: ${scoring.scores.trend}/100 (50=유지, 65+=상승, 35-=하락)
- 현재 월: ${new Date().getMonth() + 1}월
- 평균 판매가: ${keywordData.avgPrice?.toLocaleString()}원

다음 JSON 형식으로만 답변하세요. detectedCategory는 반드시 포함하세요:
${jsonSchema}`
