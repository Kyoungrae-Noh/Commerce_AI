...
function buildJsonSchema(score) {
  if (score >= 70) {
    return `{
  "conclusion": "키워드명과 핵심 숫자(검색량, 경쟁상품수)를 직접 인용하며 2-3문장으로 현황 서술.",
...
export async function generateAnalysis({ keyword, scoring, keywordData, competitionData }) {
...
2. 월간 검색량, 경쟁 상품 수, 성장률 등 실제 숫자를 문장에 인용하세요. 예: "머그컵의 월간 검색량 24,090회는 중간 수준이며..."
